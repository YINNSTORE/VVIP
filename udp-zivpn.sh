...
wget https://raw.githubusercontent.com/Farukbrowser/ClanX/main/udp-zivpn/config.json -O /etc/zivpn/config.json 1> /dev/null 2> /dev/null
...
[Unit]
Description=zivpn VPN Server by Farukbrowser
...
echo -e "Installed in ClanX by Farukbrowser"